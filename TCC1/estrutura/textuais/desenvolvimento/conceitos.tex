...
\section{ESPAÇOS MÉTRICOS} %TODO Ampliar -- Conceito de bola fechada
\label{sec:espmet}
...
\begin{figure}[H]
\centering
\includegraphics[width=.8\textwidth]{dados/figuras/desig_tri.eps} %TODO alterar segunda imagem
...
%TODO Não sera usada a distância euclidiana! Valor de p depende do database.Minkowski funciona para qualquer dataset vetorial (dimens. fixa). Adicionar dist Camberra

\section{ESTRUTURAS DE INDEXAÇÃO} %TODO indexação em memória
\label{sec:index}
...
%TODO Textura identifica padrões - muito usada em ambiente de imagens médicas (mesma categoria)
