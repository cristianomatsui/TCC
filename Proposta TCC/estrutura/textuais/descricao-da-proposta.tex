...
métodos de acesso e técnicas de estimativa do custo computacional \cite{POLA2010}. %TODO--> Melhorar isso.
...
conjunto de elementos que não foram descartados utilizando a desigualdade triangular com as distâncias previamente calculadas em relação ao foco.
